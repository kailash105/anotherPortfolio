...
return ( <section className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-gray-100">
  ...
  <div className="relative z-10 flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto px-6 md:px-12 gap-16">
    ...
    >
      ...
      <div className="relative z-10 space-y-6">
        ...
        >
          I design and develop <span className="text-cyan-400 font-medium">AI-driven web applications</span>,{" "}
          <span className="text-cyan-400 font-medium">automation systems</span>, and{" "}
          <span className="text-cyan-400 font-medium">cloud-native platforms</span> 
          that connect intelligence with usability. Passionate about merging design, 
          data, and deep learning to build scalable, human-centered digital experiences.
        </motion.p>
